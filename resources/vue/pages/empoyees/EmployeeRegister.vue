                ...
                <div class="table-wrapper">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="sgx-w-300 input-td"><input type="date" v-model="employee.join_date" :class="{'error': validation.join_date }"></td>
    ...
    export default {
        ...
        methods: {
            async employeeStore() {
                ...
                this.axios.post(conf.API.EMPLOYEE, this.employee)
                    .then((response) => {
